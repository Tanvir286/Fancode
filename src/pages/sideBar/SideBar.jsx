    ...
    return (
        <div className='MainBar'>
             ...
             {/* Icon Here  */}
              ...
              <Link to="/home" className={location.pathname == "/home" ? "Live" : "nonLive" } > <SideBarIcon  Iconname={<IoHomeOutline />}  Deatils="Dashboard" className="SideBarIcon"  /> </Link>
              
              <Link to="/home/message" className={location.pathname == "/home/message" ? "Live" : "nonLive" } > <SideBarIcon  Iconname={<AiFillMessage />}  Deatils="Messages" className="SideBarIcon"  /> </Link>

              <Link to="/home/Alert"  className={location.pathname == "/home/Alert" ? "Live" : "nonLive" } > <SideBarIcon  Iconname={<IoNotificationsSharp />}  Deatils="Notification" className="SideBarIcon"  /> </Link>
